...
!define setup "Fertspa studios Logitask Administrativo.exe"
 
; change this to wherever the files to be packaged reside
!define srcdir "C:\Users\agusa\Desktop\slta - no repo version\COMPILADO ADMIN\"
 
!define company "Fertspa Administrativo"
 
!define prodname "Fertspa Administrativo"
!define exec "SltaAdmin.exe"
...
File /a "${srcdir}\${exec}"
 File /a "${srcdir}\GMap.NET.Core.dll"
 File /a "${srcdir}\GMap.NET.WindowsForms.dll"
 File /a "${srcdir}\LibreriaDatos.dll"
 File /a "${srcdir}\LibreriaGrafica.dll"
 File /a "${srcdir}\LibreriaLogica.dll"
 File /a "${srcdir}\MessagingToolkit.QRCode.dll"
 File /a "${srcdir}\WebCAM.dll"
